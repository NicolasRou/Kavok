...
/* ── Static data ──────────────────────────────────────── */
const ITEMS = [
  { t: "const studio = await kavok.create()", x: 4,  y: 12, f: 0.12, sz: 11, op: 0.09 },
  { t: "export default function Dashboard()",  x: 60, y: 33, f: 0.23, sz: 11, op: 0.08 },
  { t: "<MyStudio plan='pro' />",              x: 7,  y: 62, f: 0.09, sz: 12, op: 0.10 },
  { t: "type Lead = { name: string }",          x: 68, y: 70, f: 0.29, sz: 11, op: 0.08 },
  { t: "import { ai } from '@kavok/core'",      x: 28, y: 87, f: 0.18, sz: 11, op: 0.09 },
  { t: "{  }",                                  x: 2,  y: 42, f: 0.11, sz: 36, op: 0.05 },
  { t: "</>",                                   x: 84, y: 20, f: 0.34, sz: 30, op: 0.06 },
  { t: "=>",                                    x: 52, y: 8,  f: 0.17, sz: 28, op: 0.06 },
  { t: "( )",                                   x: 20, y: 80, f: 0.21, sz: 26, op: 0.06 },
  { t: "{ }",                                   x: 78, y: 55, f: 0.15, sz: 32, op: 0.05 },
]
